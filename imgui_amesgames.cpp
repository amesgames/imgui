...
namespace ImGui {
    namespace Amesgames {
        ...
        static ImVector<ImGuiStyle> styles;

        void SetupStyle() {
            ImGuiIO& io = ImGui::GetIO();

            if (io.srcColorStyleNames)
                IM_FREE(io.srcColorStyleNames);

            io.srcColorStyleNames = (char*)IM_ALLOC(sizeof("Dark\0Light\0"));
            strcpy_s(io.srcColorStyleNames, sizeof("Dark\0Light\0"), "Dark\0Light\0");

            styles.resize(2);
            StyleColorsDark(&styles[0]);
            StyleColorsLight(&styles[1]);

            ImGuiStyle& style = ImGui::GetStyle();

            for (int i = 0; i < ImGuiCol_COUNT; i++)
                style.Colors[i] = styles[style_idx].Colors[i];

            style.Alpha = 1.000000f;
            style.DisabledAlpha = 0.600000f;
            style.WindowPadding.x = 8.000000f;
            style.WindowPadding.y = 8.000000f;
            style.WindowRounding = 0.000000f;
            style.WindowBorderSize = 1.000000f;
            style.WindowMinSize.x = 32.000000f;
            style.WindowMinSize.y = 32.000000f;
            style.WindowTitleAlign.x = 0.000000f;
            style.WindowTitleAlign.y = 0.500000f;
            ...
            style.FramePadding.x = 4.000000f;
            style.FramePadding.y = 3.000000f;
            style.FrameRounding = 0.000000f;
            style.FrameBorderSize = 0.000000f;
            style.ItemSpacing.x = 8.000000f;
            style.ItemSpacing.y = 4.000000f;
            style.ItemInnerSpacing.x = 4.000000f;
            style.ItemInnerSpacing.y = 4.000000f;
            style.CellPadding.x = 4.000000f;
            style.CellPadding.y = 2.000000f;
            style.TouchExtraPadding.x = 0.000000f;
            style.TouchExtraPadding.y = 0.000000f;
            style.IndentSpacing = 21.000000f;
            style.ColumnsMinSpacing = 6.000000f;
            style.ScrollbarSize = 14.000000f;
            style.ScrollbarRounding = 9.000000f;
            style.GrabMinSize = 10.000000f;
            style.GrabRounding = 0.000000f;
            style.LogSliderDeadzone = 4.000000f;
            style.TabRounding = 4.000000f;
            style.TabBorderSize = 0.000000f;
            style.TabMinWidthForCloseButton = 0.000000f;
            style.ColorButtonPosition = ImGuiDir_Right;
            style.ButtonTextAlign.x = 0.500000f;
            style.ButtonTextAlign.y = 0.500000f;
            style.SelectableTextAlign.x = 0.000000f;
            style.SelectableTextAlign.y = 0.000000f;
            style.DisplayWindowPadding.x = 19.000000f;
            style.DisplayWindowPadding.y = 19.000000f;
            style.DisplaySafeAreaPadding.x = 3.000000f;
            style.DisplaySafeAreaPadding.y = 3.000000f;
            style.MouseCursorScale = 1.000000f;
            style.AntiAliasedLines = true;
            style.AntiAliasedLinesUseTex = true;
            style.AntiAliasedFill = true;
            style.CurveTessellationTol = 1.250000f;
            style.CircleTessellationMaxError = 0.300000f;
        }

        void StyleColorsDark(ImGuiStyle * ref) {
            ref = ref ? ref : &ImGui::GetStyle();
            ImVec4* colors = ref->Colors;
        ...
        void StyleColorsLight(ImGuiStyle * ref) {
            ref = ref ? ref : &ImGui::GetStyle();
            ImVec4* colors = ref->Colors;
        ...
        {
            int prev_style_idx = style_idx;
            if (ImGui::Combo("Amesgames Colors##Selector", &style_idx, "Dark\0Light\0"))
            {
                ImGuiStyle& style = ImGui::GetStyle();
                for (int i = 0; i < ImGuiCol_COUNT; i++)
                    styles[prev_style_idx].Colors[i] = style.Colors[i];
                for (int i = 0; i < ImGuiCol_COUNT; i++)
                    style.Colors[i] = styles[style_idx].Colors[i];
            }
        ...
        const char font_compressed_data_base85[144680+1] =
